/**
 * @file Frustum.h
 * @brief A header file for the Frustum class.
 * 
 * This file contains the definition and implementation of the Frustum class,
 * which provides functionality for frustum culling in a 3D space.
 * 
 * @note This file is part of the CoffeeEngine project.
 * @note The original code is based on https://gist.github.com/podgorskiy/e698d18879588ada9014768e3e82a644 and is licensed under the MIT License.
 * 
 * @class Frustum
 * @brief A class for frustum culling.
 * 
 * The Frustum class provides methods to determine whether a bounding box is visible
 * within the frustum defined by a view-projection matrix.
 * 
 * @section License
...
namespace Coffee
{
    ...
    public:
        ...
        // Get the 8 points of the frustum
    ...
    // http://iquilezles.org/www/articles/frustumcorrect/frustumcorrect.htm
    inline bool Frustum::Contains(const AABB& aabb) const
    {
